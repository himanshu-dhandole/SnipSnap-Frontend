...
const NavBar = () => {
  ...
  return (
    <nav className="fixed w-full top-0 z-50 backdrop-blur-sm bg-white/10  border-white/18">
            ...
            {navItems.map((item) => (
              <Link
                ...
                className={`text-white/90 hover:text-white transition-colors ${
                  isActive(item.path) ? "border-b-2 border-amber-50" : ""
                }`}
              >
                {item.label}
              </Link>
          ...
          <div className="md:hidden">
            <div className="px-2 pt-2 pb-3 space-y-1">
              {navItems.map((item) => (
                <Link
                  ...
                  className={`block px-3 py-2 text-white/90 hover:text-white transition-colors ${
                    isActive(item.path) ? "bg-teal-600 rounded-md" : ""
                  }`}
              ...
              <Link to="/signin" onClick={() => setIsOpen(false)}>
                <button
                  className={`w-full mt-2 bg-white text-teal-600 px-4 py-2 rounded-lg font-semibold hover:bg-opacity-90 transition-all ${
                    isActive("/signin") ? "bg-opacity-70" : ""
                  }`}
                >
                  Sign In
